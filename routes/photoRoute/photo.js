...
const { uploadPhoto, getAllPhotos, filterPhotos, getByScene, getTopPhotos, getPhotosWithFaces, getFlaggedPhotos, searchPhotos } = require('../../controller/photoController/photo')
